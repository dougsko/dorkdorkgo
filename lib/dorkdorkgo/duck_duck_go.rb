...
module DorkDorkGo
    class DuckDuckGo
        ...
        def search(q)
            ...
            page = Nokogiri::HTML(RestClient.post("https://duckduckgo.com/html", {'q' => @q}, :user_agent => UserAgent.get_agent ))
            while true
                params = {}
                ...
                sleep(sleep_time)
                begin
                    page = Nokogiri::HTML(RestClient.post("https://duckduckgo.com/html", params, :user_agent => UserAgent.get_agent ))
